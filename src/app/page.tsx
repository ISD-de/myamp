...
export default function Home(): React.JSX.Element {
  ...
  return (
    <main className="relative min-h-screen w-full bg-theme-bg text-theme-text font-mono overflow-hidden transition-colors duration-300 pointer-events-auto">
        ...
        <div className="relative z-10 p-2 flex flex-col gap-2 pointer-events-auto">
          ...
          {showVisSettings && (
            <div className="flex flex-col">
              ...
              <div className="flex flex-col gap-1 border-2 border-theme-border -mt-0.5 bg-theme-panel/90 backdrop-blur-md p-1.5 shadow-2xl transition-colors duration-300">
      ...
      {isPlaylistOpen && (
        <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-md flex items-center justify-center p-2">
          <div className="bg-theme-panel border-2 border-theme-border shadow-2xl w-[90vw] h-[90vh] flex flex-col overflow-hidden transition-colors duration-300">
