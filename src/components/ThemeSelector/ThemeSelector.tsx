...
export const ThemeSelector: React.FC = () => {
  ...
  return (
    <div className="flex items-center gap-1 bg-theme-panel p-1.5 border-2 border-theme-border">
      ...
      {themes.map((t) => (
        <button
          ...
          className={`text-xs px-2 py-0.5 border transition active:scale-95 cursor-pointer ${
            theme === t.id
