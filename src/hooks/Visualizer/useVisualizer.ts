...
export function useVisualizer({
  ...
  // Initialisierung, Audio-Anbindung und Render-Loop
  useEffect(() => {
  ...
  }, [audioElement, audioContext, sourceNode, containerRef, canvasRef]);
  
  // Steuerungsfunktionen für externe Aufrufe (via Ref)
  const nextPreset = () => {
